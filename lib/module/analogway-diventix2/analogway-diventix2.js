// Analog Way Di-Venti-X 2 TCP / UDP
// Build on Analog Way Pulse 300 TCP / UDP
...
instance.prototype.CHOICES_INPUTS = [
	...
	{ id: '9',  label: 'Input 7',  text: 'In 7' },
	{ id: '10', label: 'Input 8',  text: 'In 8' }
];
...
instance.prototype.CHOICES_FRAMES = [
	...
	{ id: '7', label: 'Frame 7',  text: 'Fr 7' },
	{ id: '8', label: 'Frame 8',  text: 'Fr 8' }
];
...
instance.prototype.action = function(action) {
	...
	switch(action.action) {
		...
		case 'in':
			cmd = '1,1,' + opt.input + 'IN' + '\r\n' + '1,1,' + opt.input + 'IN' ;
			break;

		case 'fr':
			cmd = '0,1,' + opt.frame + 'IN' + '\r\n' + '0,1,' + opt.frame + 'IN';
			break;
